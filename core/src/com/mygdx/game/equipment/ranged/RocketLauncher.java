	...
	private final static HitboxFactory onShoot = new HitboxFactory() {
		...
		public Hitbox[] makeHitbox(final Schmuck user, PlayState state, Vector2 startVelocity, float x, float y, short filter,
            ...
            if (comp460game.serverMode) {
                comp460game.server.server.sendToAllTCP(new Packets.PlaySound(AssetList.SFX_RL.toString(), 1.0f));
            }
//			Sound sound = Gdx.audio.newSound(Gdx.files.internal(AssetList.SFX_RL.toString()));
//			sound.play(1.0f);
